(custom-set-variables
 ...
 '(custom-safe-themes
   '("3a3de615f80a0e8706208f0a71bbcc7cc3816988f971b6d237223b6731f91605" "9b35c097a5025d5da1c97dba45fed027e4fb92faecbd2f89c2a79d2d80975181" "dcf7154867ba67b250fe2c5cdc15a7d170acd9cbe6707cc36d9dd1462282224d"))
 '(inhibit-startup-screen t)
 '(org-agenda-files
   '("~/.emacs.d/config.org" "~/Notebooks/org/gcal.org" "~/Notebooks/org/i.org"))
 '(package-selected-packages
   '(virtualenvwrapper elpy beacon git-gutter undohist dot-mode ox-reveal highlight-numbers doom-modeline magic-latex-buffer pdf-tools auctex-latexmk company-auctex auctex treemacs-projectile treemacs doom-themes command-log-mode golden-ratio-scroll-screen use-package-chords yaml-mode wrap-region iedit expand-region exwm-edit dumb-jump exwm-systemtray exwm xref-js2 js2-refactor js2-mode emmet-mode polymode aggressive-indent agressive-indent atomic-chrome counsel-projectile ace-window ob-kotlin kotlin-mode flatland-theme projectile yasnippet htmlize vterm org-gcal spaceline rainbow-delimiters sudo-edit hungry-delete rainbow-mode rg fzf memoize diff-hl org-bullets which-key magit deferred company adoc-mode dashboard all-the-icons page-break-lines ranger)))
(custom-set-faces
